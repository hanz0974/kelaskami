<div id="modal-tugas" tabindex="-1" wire:ignore.self
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                    {{ $mode === 'create' ? 'Tambah tugas' : 'Edit tugas' }}
                </h3>
                <button type="button"
                    ...
                    wire:click.prevent="closeModaltugas">
            ...
            <form wire:submit.prevent="savetugas">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <input wire:model="kode_mk" class="hidden">
                    <div>
                        <label for="title"
                    ...
                    <div>
                        <label for="Kode tugas"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kode tugas</label>
                        <input wire:model="kode_tugas" type="text" name="kode_tugas" id="kode_tugas"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    ...
                    <div>
                        ...
                        <input wire:model="deadline" type="datetime-local" id="deadline" name="deadline"
                    ...
                    <div>
                        ...
                        <input wire:model="file_tugas"
                            class="cursor-pointer bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full shadow-xs placeholder:text-body"
                            id="file_tugas" name="file_tugas" type="file" accept=".docx, .pdf, .pptx">
                        @if ($existingFiletugas && !$file_tugas)
                            <a href="{{ asset('/storage/' . $existingFiletugas) }}" target="_blank"
