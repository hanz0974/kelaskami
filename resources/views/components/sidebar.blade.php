...
<aside
    ...
    <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        ...
        <ul class="space-y-2">
            <li>
                <x-side-link :href="route('home')" :active="request()->is('/')">
            ...
            <li>
                <button type="button"
                    ...
                    <span class="flex-1 ml-3 text-left whitespace-nowrap">Class</span>
                ...
                <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                    @foreach ($matakuliah as $mk)
                        <li>
                            <x-side-link :href="route('class.index', ['kode_mk' => $mk->kode_mk])" class="pl-11"
                                :active="request()->is('class/' . $mk->kode_mk) || request()->is('class/' . $mk->kode_mk . '/*')">
                                {{ $mk->nama }}
                            </x-side-link>
                        </li>
                    @endforeach
            ...
            <li>
                <x-side-link :href="route('absen')" :active="request()->is('absen')">
